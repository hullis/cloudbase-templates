...
### [#](#_14-iterator迭代器) 14 Iterator迭代器
...
![](http://img-repo.poetries.top/images/20210407141323.png)

### [#](#_15-promise) 15 Promise
...
![](http://img-repo.poetries.top/images/20210414175500.png)
...
![](http://img-repo.poetries.top/images/20210414210720.png)
...
![](http://img-repo.poetries.top/images/20210408100806.png)
...
### [#](#_17-async-await) 17 async/await
...
![](http://img-repo.poetries.top/images/20210414210917.png)

### [#](#_18-事件循环) 18 事件循环

![](http://img-repo.poetries.top/images/20210516161332.png)
...
![](http://img-repo.poetries.top/images/20210516162034.png) ![](http://img-repo.poetries.top/images/20210516162330.png)

> 自动执行的情况 会输出 listener1 listener2 task1 task2

![](http://img-repo.poetries.top/images/20210516162704.png) ![](http://img-repo.poetries.top/images/20210516163038.png)

> 如果手动点击click 会一个宏任务取出来一个个执行，先执行click的宏任务，取出微任务去执行。会输出 listener1 task1 listener2 task2

![](http://img-repo.poetries.top/images/20210516163647.png)
...
![](https://poetries1.gitee.io/img-repo/2020/09/10.png)
...
*   `Object.observe`
*   `MutationObserver`
    *   ![](http://img-repo.poetries.top/images/20210516165328.png)
...
![](http://img-repo.poetries.top/images/20210414213126.png)
...
![](http://img-repo.poetries.top/images/20210414211816.png)
...
![](http://img-repo.poetries.top/images/20210414211850.png) ![](http://img-repo.poetries.top/images/20210516214402.png) ![](http://img-repo.poetries.top/images/20210516221825.png)
...
![](http://img-repo.poetries.top/images/20210414212124.png)
...
![](http://img-repo.poetries.top/images/20210424174311.png)
...
![](http://img-repo.poetries.top/images/20210516224232.png)
...
![](http://img-repo.poetries.top/images/20210414213602.png)
...
![](http://img-repo.poetries.top/images/20210529172258.png)
...
![](http://img-repo.poetries.top/images/20210414212916.png)
...
![](http://img-repo.poetries.top/images/20210414142630.png)
...
![](http://img-repo.poetries.top/images/20210414134752.png)
...
![](http://img-repo.poetries.top/images/20210414141731.png)
...
![](http://img-repo.poetries.top/images/20210414142525.png)
...
![](https://poetries1.gitee.io/img-repo/2020/09/9.png)
...
![](http://img-repo.poetries.top/images/20210414163215.png)
...
![](https://poetries1.gitee.io/img-repo/2020/09/7.png) ![](https://poetries1.gitee.io/img-repo/2020/09/8.png)
...
![](http://img-repo.poetries.top/images/20210414164546.png)
...
![](http://img-repo.poetries.top/images/20210414164425.png)
...
![](http://img-repo.poetries.top/images/20210414164820.png)
...
![](http://img-repo.poetries.top/images/20210414164939.png)
...
![](http://img-repo.poetries.top/images/20210414165705.png)
...
![](http://img-repo.poetries.top/images/20210414170410.png)
...
![](http://img-repo.poetries.top/images/20210414170438.png)
...
![](http://img-repo.poetries.top/images/20210414170747.png)
...
![](http://img-repo.poetries.top/images/20210414171508.png)
...
### [#](#_1-meta-标签-自动刷新-跳转) 1 meta 标签：自动刷新/跳转
...
![](http://img-repo.poetries.top/images/20210421163450.png)
...
*   `dns-prefetch`。当 `link` 标签的 `rel` 属性值为“dns-prefetch”时，`浏览器会对某个域名预先进行 DNS 解析并缓存`。这样，当浏览器在请求同域名资源的时候，能省去从域名查询 IP 的过程，从而`减少时间损耗`。下图是淘宝网设置的 DNS 预解析 ![](http://img-repo.poetries.top/images/20210421163848.png)
...
![](http://img-repo.poetries.top/images/20210421164758.png)
...
![](https://poetries1.gitee.io/img-repo/2020/09/111.png)
...
### [#](#_8-左边定宽-右边自适应方案) 8 左边定宽，右边自适应方案
...
### [#](#_9-左右两边定宽-中间自适应) 9 左右两边定宽，中间自适应
...
### [#](#_12-列举几个css中可继承和不可继承的元素) 12 列举几个css中可继承和不可继承的元素
...
![](http://img-repo.poetries.top/images/20210415090353.png)
...
![](http://img-repo.poetries.top/images/20210415092040.png)
...
![](http://img-repo.poetries.top/images/20210415092356.png)
...
### [#](#_2-javascript单线程模型) 2 JavaScript单线程模型
...
### [#](#_3-chrome-打开一个页面需要启动多少进程-分别有哪些进程) 3 Chrome 打开一个页面需要启动多少进程？分别有哪些进程？
...
![](http://img-repo.poetries.top/images/20210421172522.png)
...
### [#](#_8-xss-和-csrf) 8 XSS 和 CSRF

![](http://img-repo.poetries.top/images/20210415090547.png)
...
![](http://img-repo.poetries.top/images/20210506174602.png)
...
![](http://img-repo.poetries.top/images/20210506174856.png)
...
![](http://img-repo.poetries.top/images/20210506175834.png)
...
### [#](#_9-service-worker) 9 Service Worker
...
![](https://poetries1.gitee.io/img-repo/2020/09/96.png)

> 在 Cache 中也可以发现我们所需的文件已被缓存

![](https://poetries1.gitee.io/img-repo/2020/09/97.png)

> 当我们重新刷新页面可以发现我们缓存的数据是从 `Service` `Worker` 中读取的

### [#](#_10-dom-节点操作) 10 DOM 节点操作
...
![](http://img-repo.poetries.top/images/20210420215756.png)
...
### [#](#_12-从输入url到页面展示过程) 12 从输入URL到页面展示过程

![](http://img-repo.poetries.top/images/20210504134355.png)

**1\. DNS域名解析**

![](http://img-repo.poetries.top/images/20210504134816.png)
...
![](http://img-repo.poetries.top/images/20210504134850.png)
...
![](http://img-repo.poetries.top/images/20210504134913.png)

结合起来的过程，可以用一个图表示：

![](http://img-repo.poetries.top/images/20210504134925.png)
...
![](http://img-repo.poetries.top/images/20210504135417.png)
...
![](http://img-repo.poetries.top/images/20210504135549.png)
...
![](http://img-repo.poetries.top/images/20210504135701.png)
...
![](http://img-repo.poetries.top/images/20210504135900.png)
...
![](http://img-repo.poetries.top/images/20210504140042.png)
...
### [#](#_13-渲染引擎什么情况下才会为特定的节点创建新的图层) 13 渲染引擎什么情况下才会为特定的节点创建新的图层
...
### [#](#_14-定时器与requestanimationframe、requestidlecallback) 14 定时器与requestAnimationFrame、requestIdleCallback
...
![](http://img-repo.poetries.top/images/20210504201448.png)
...
![](http://img-repo.poetries.top/images/20210504201623.png)
...
![](http://img-repo.poetries.top/images/20210504202154.png)
...
![](http://poetries1.gitee.io/img-repo/20190922/vue.jpeg)
...
### [#](#_2-发布订阅模式和观察者模式) 2 发布订阅模式和观察者模式
...
### [#](#_3-为什么使用-virtual-dom) 3 为什么使用 Virtual DOM
...
### [#](#_4-vdom-三个-part) 4 VDOM：三个 part
...
### [#](#_5-vue-和-react技术选型) 5 vue 和 react技术选型
...
![](http://img-repo.poetries.top/images/20210408093135.png)
...
### [#](#_10-vue3带来的新特性-亮点) 10 vue3带来的新特性/亮点
...
![](http://img-repo.poetries.top/images/20210407162653.png)
...
### [#](#_11-compositon-api) 11 Compositon api
...
### [#](#_12-computed-的实现原理) 12 computed 的实现原理
...
### [#](#_14-vue-渲染过程) 14 vue 渲染过程

![](http://img-repo.poetries.top/images/20210504211204.png)
...
### [#](#_15-说一说keep-alive实现原理) 15 说一说keep-alive实现原理
...
### [#](#_16-为什么访问data属性不需要带data) 16 为什么访问data属性不需要带data
...
### [#](#_17-template预编译是什么) 17 template预编译是什么
...
### [#](#_18-介绍一下vue中的diff算法) 18 介绍一下Vue中的Diff算法
...
### [#](#_19-说说vue2-0和vue3-0有什么区别) 19 说说Vue2.0和Vue3.0有什么区别
...
### [#](#_1-谈谈你对react的理解) 1 谈谈你对React的理解
...
### [#](#_2-如何避免react生命周期中的坑) 2 如何避免React生命周期中的坑

**16.3版本**

![](http://img-repo.poetries.top/images/20210409153251.png)

**>=16.4版本**

![](http://img-repo.poetries.top/images/20210409153312.png)
...
![](http://img-repo.poetries.top/images/20210425121355.png)
...
![](http://img-repo.poetries.top/images/20210426200953.png)
...
![](http://img-repo.poetries.top/images/20210426201045.png)
...
![](http://img-repo.poetries.top/images/20210426201155.png)
...
> *   [React16为什么要更改生命周期 (opens new window)](http://interview.poetries.top/principle-docs/react/12-React16%E4%B8%BA%E4%BB%80%E4%B9%88%E8%A6%81%E6%9B%B4%E6%94%B9%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F(%E4%B8%8A).html)
> *   [React16为什么要更改生命周期 (opens new window)](http://interview.poetries.top/principle-docs/react/12-React16%E4%B8%BA%E4%BB%80%E4%B9%88%E8%A6%81%E6%9B%B4%E6%94%B9%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F(%E4%B8%8B).html)

### [#](#_3-react-fiber架构) 3 React Fiber架构
...
![](http://img-repo.poetries.top/images/20210407173320.png)
...
![](http://img-repo.poetries.top/images/20210407174007.png)
...
![](http://img-repo.poetries.top/images/20210407173933.png)
...
![](http://img-repo.poetries.top/images/20210407173949.png)
...
### [#](#_4-createelement过程) 4 createElement过程
...
### [#](#_5-调和阶段-setstate内部干了什么) 5 调和阶段 setState内部干了什么
...
![](http://img-repo.poetries.top/images/20210425140749.png)
...
![](http://img-repo.poetries.top/images/20210409153900.png) ![](http://img-repo.poetries.top/images/20210409153914.png) ![](http://img-repo.poetries.top/images/20210409153926.png) ![](http://img-repo.poetries.top/images/20210409153942.png) ![](http://img-repo.poetries.top/images/20210409154004.png) ![](http://img-repo.poetries.top/images/20210409154015.png)
...
### [#](#_7-setstate原理分析) 7 setState原理分析
...
### [#](#_8-react事务机制) 8 React事务机制

![](http://img-repo.poetries.top/images/20210409154118.png) ![](http://img-repo.poetries.top/images/20210409154127.png) ![](http://img-repo.poetries.top/images/20210409154136.png)

### [#](#_9-react组件和渲染更新过程) 9 React组件和渲染更新过程
...
### [#](#_10-如何解释-react-的渲染流程) 10 如何解释 React 的渲染流程

![](http://img-repo.poetries.top/images/20210425210718.png)
...
### [#](#_11-diff算法是怎么运作) 11 diff算法是怎么运作
...
![](http://img-repo.poetries.top/images/20210307225249.png)
...
![](http://img-repo.poetries.top/images/20210425203918.png)

> diff 算法探讨的就是虚拟 DOM 树发生变化后，生成 DOM 树更新补丁的方式。它通过对比新旧两株虚拟 DOM 树的变更差异，将更新补丁作用于真实 DOM，以最小成本完成视图更新

![](http://img-repo.poetries.top/images/20210425204127.png)
...
![](http://img-repo.poetries.top/images/20210425204151.png)
...
![](http://img-repo.poetries.top/images/20210425135711.png)
...
![](http://img-repo.poetries.top/images/20210425135751.png)
...
![](http://img-repo.poetries.top/images/20210409153648.png)
...
![](http://img-repo.poetries.top/images/20210407215708.png) ![](http://img-repo.poetries.top/images/20210407215721.png)
...
![](http://img-repo.poetries.top/images/20210407215754.png)
...
![](http://img-repo.poetries.top/images/20210426192237.png)

> createElement 中并没有十分复杂的涉及算法或真实 DOM 的逻辑，它的每一个步骤几乎都是在格式化数据。

![](http://img-repo.poetries.top/images/20210426192648.png)
...
![](http://img-repo.poetries.top/images/20210426193812.png)
...
![](http://img-repo.poetries.top/images/20210426193901.png)

这个 `ReactElement` 对象实例，本质上是以 JavaScript 对象形式存在的对 `DOM` 的描述，也就是老生常谈的“虚拟 DOM”（准确地说，是虚拟 `DOM` 中的一个节点)

### [#](#_14-为什么-react-元素有一个-typeof-属性) 14 为什么 React 元素有一个 $$typeof 属性
...
### [#](#_15-virtual-dom-的工作原理是什么) 15 Virtual DOM 的工作原理是什么

![](http://img-repo.poetries.top/images/20210425201821.png)
...
### [#](#_16-react有哪些优化性能的手段) 16 React有哪些优化性能的手段
...
### [#](#_17-redux实现原理解析) 17 Redux实现原理解析
...
![](http://poetries1.gitee.io/img-repo/2020/07/68.png)
...
![](http://img-repo.poetries.top/images/20210426215948.png)
...
![](http://img-repo.poetries.top/images/20210427115241.png)
...
![](http://img-repo.poetries.top/images/20210427115322.png)

### [#](#_18-谈谈你对状态管理的理解) 18 谈谈你对状态管理的理解
...
![](http://img-repo.poetries.top/images/20210425201200.png)

### [#](#_19-connect组件原理分析) 19 connect组件原理分析
...
### [#](#_20-react-hooks) 20 React Hooks
...
![](http://img-repo.poetries.top/images/20210425213051.png)
...
![](http://img-repo.poetries.top/images/20210425213302.png)
...
### [#](#_22-如何避免ajax数据请求重新获取) 22 如何避免ajax数据请求重新获取

> 一般而言，ajax请求的数据都放在redux中存取。

### [#](#_23-组件之间通信) 23 组件之间通信
...
![](http://img-repo.poetries.top/images/20210425145857.png)

### [#](#_24-类组件与函数组件有什么区别呢) 24 类组件与函数组件有什么区别呢？
...
![](http://img-repo.poetries.top/images/20210425134417.png)

### [#](#_25-如何设计react组件) 25 如何设计React组件
...
![](http://img-repo.poetries.top/images/20210425134939.png)

### [#](#_26-组件的协同及-不-可控组件) 26 组件的协同及（不）可控组件

**为什么要进行组件的协同**

*   我们在实际的开发项目的时候，不会只用几个组件，有时候遇到大型的项目，可能会有成千上百的组件，难免会遇到有功能重复的组件。要进行修改，就会修改大部分的文件。所以我们需要进行组件的协同开发。

![](http://img-repo.poetries.top/images/20210427114453.png)
...
![](http://img-repo.poetries.top/images/20210427114544.png)
...
![](http://img-repo.poetries.top/images/20210427114655.png)
...
![](http://img-repo.poetries.top/images/20210427114820.png)
...
![](http://img-repo.poetries.top/images/20210427114833.png)
...
### [#](#_27-react-router-的实现原理及工作方式分别是什么) 27 React-Router 的实现原理及工作方式分别是什么
...
![](http://img-repo.poetries.top/images/20210425214114.png)

![](http://img-repo.poetries.top/images/20210409164620.png)
...
### [#](#_28-react-17-带来了哪些改变) 28 React 17 带来了哪些改变
...
### [#](#_9-如何根据chrome的timing优化) 9 如何根据chrome的timing优化
...
### [#](#_1-介绍一下-webpack-的构建流程) 1 介绍一下 webpack 的构建流程
...
![](http://img-repo.poetries.top/images/20210422211832.png)
...
![](http://img-repo.poetries.top/images/20210517175408.png)
...
![](http://img-repo.poetries.top/images/20210503212144.png)

**webpack详细工作流程**

![](http://img-repo.poetries.top/images/20210517174932.png)

### [#](#_2-介绍-loader) 2 介绍 Loader
...
### [#](#_4-webpack-热更新实现原理) 4 webpack 热更新实现原理

![](http://img-repo.poetries.top/images/20210319101659.png)

**HMR 的基本流程图**

![](http://img-repo.poetries.top/images/20210422211446.png)
...
### [#](#_5-webpack-层面如何做性能优化) 5 webpack 层面如何做性能优化
...
![](http://img-repo.poetries.top/images/20210409165629.png) ![](http://img-repo.poetries.top/images/20210409165723.png)

### [#](#_6-介绍一下-tree-shaking) 6 介绍一下 Tree Shaking
...
### [#](#_7-介绍一下-webpack-scope-hosting) 7 介绍一下 webpack scope hosting

> 作用域提升，将分散的模块划分到同一个作用域中，避免了代码的重复引入，有效减少打包后的代码体积和运行时的内存损耗；

### [#](#_8-webpack-proxy工作原理-为什么能解决跨域) 8 Webpack Proxy工作原理？为什么能解决跨域
...
![](http://img-repo.poetries.top/images/20210507090546.png)

在代理服务器传递数据给本地浏览器的过程中，两者同源，并不存在跨域行为，这时候浏览器就能正常接收数据

> 注意：`「服务器与服务器之间请求数据并不会存在跨域行为，跨域行为是浏览器安全策略限制」`

### [#](#_9-介绍一下-babel原理) 9 介绍一下 babel原理
...
![](http://img-repo.poetries.top/images/20210704203811.png)
...
### [#](#_2-http世界全览) 2 HTTP世界全览

![](http://img-repo.poetries.top/images/20210503202857.png)
...
![](http://img-repo.poetries.top/images/20210503203408.png) ![](http://img-repo.poetries.top/images/20210507090818.png)
...
### [#](#_4-http报文是什么样子的) 4 HTTP报文是什么样子的
...
![](http://img-repo.poetries.top/images/20210503203917.png)

![](http://img-repo.poetries.top/images/20210503203927.png)

### [#](#_5-http之url) 5 HTTP之URL
...
### [#](#_7-谈一谈http协议优缺点) 7 谈一谈HTTP协议优缺点
...
### [#](#_8-说一说http-的请求方法) 8 说一说HTTP 的请求方法
...
### [#](#_9-谈一谈get-和-post-的区别) 9 谈一谈GET 和 POST 的区别
...
### [#](#_11-谈一谈http数据传输) 11 谈一谈HTTP数据传输
...
### [#](#_12-cookie-和-session) 12 cookie 和 session
...
### [#](#_13-介绍一下https和http区别) 13 介绍一下HTTPS和HTTP区别
...
### [#](#_15-介绍一个https工作原理) 15 介绍一个HTTPS工作原理
...
### [#](#_16-ssl-连接断开后如何恢复) 16 SSL 连接断开后如何恢复
...
### [#](#_17-谈一谈你对http-2理解) 17 谈一谈你对HTTP/2理解
...
### [#](#_19-http-1-0-http1-1-http2-0版本之间的差异) 19 HTTP/1.0 HTTP1.1 HTTP2.0版本之间的差异
...
![](http://img-repo.poetries.top/images/20210503210054.png)

**我们通过一张图来看看它的查询过程吧**👇

![](http://img-repo.poetries.top/images/20210409102754.png)

这张图很生动的展示了DNS在本地DNS服务器是如何查询的，**一般向本地DNS服务器发送请求是递归查询的**

本地 DNS 服务器向其他域名服务器请求的过程是迭代查询的过程👇

![](http://img-repo.poetries.top/images/20210409102812.png)
...
### [#](#_21-短轮询、长轮询和-websocket-间的区别) 21 短轮询、长轮询和 WebSocket 间的区别
...
### [#](#_22-说一说正向代理和反向代理) 22 说一说正向代理和反向代理
...
### [#](#_23-介绍一下connection-keep-alive) 23 介绍一下Connection:keep-alive
...
![](http://img-repo.poetries.top/images/20210409103238.png)
...
### [#](#_24-http-https-协议总结) 24 http/https 协议总结
...
### [#](#_25-tcp为什么要三次握手) 25 TCP为什么要三次握手
...
![](http://img-repo.poetries.top/images/20210426214034.png)

> 你可以能会问，2 次握手就足够了？。但其实不是，因为服务端还没有确定客户端是否准备好了。比如步骤 3 之后，服务端马上给客户端发送数据，这个时候客户端可能还没有准备好接收数据。因此还需要增加一个过程

![](http://img-repo.poetries.top/images/20210421174925.png)
...
![](http://img-repo.poetries.top/images/20210426214118.png)
...
### [#](#_26-为什么要有-websocket) 26 为什么要有 WebSocket
...
![](http://img-repo.poetries.top/images/20210503205601.png)
...
### [#](#_27-udp和tcp有什么区别) 27 UDP和TCP有什么区别
...
![](http://img-repo.poetries.top/images/20210504140502.png)

[#](#十一、9种前端常见的设计模式) 十一、9种前端常见的设计模式
-----------------------------------
